...
# CITSD-108: "Validation correction required" email is being sent to customer when Validation PASSED
## Overview
- **Status**: Closed
- **Created**: 2022-10-20
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-108)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
