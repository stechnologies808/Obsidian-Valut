...
# HESD-9: CIT HECOProcessor unable to approve withdrawal; Process phase Withdrawn
## Overview
- **Status**: Resolved
- **Created**: 2022-03-15
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-9)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
