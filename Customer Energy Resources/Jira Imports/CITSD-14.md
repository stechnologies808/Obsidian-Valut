...
# CITSD-14: "PV Contractor Needed?" question should only appear for Amendments
## Overview
- **Status**: Resolved
- **Created**: 2022-01-25
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-14)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
