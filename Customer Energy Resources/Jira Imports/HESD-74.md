...
# HESD-74: Environment TEST - Regression Testing: External Contractor Queue View Filter Options not returning expected results
## Overview
- **Status**: Closed
- **Created**: 2022-05-10
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-74)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
