...
# CITSD-25: Remove the text when choosing Modify Service CID_ModifyService_TimelineMsg
## Overview
- **Status**: Resolved
- **Created**: 2022-02-04
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-25)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
