...
# CITSD-260: ALM 84 TEST UAT - Application Summary (before submission) - Project System Components Errors / Missing fields
## Overview
- **Status**: Resolved
- **Created**: 2023-04-11
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-260)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
