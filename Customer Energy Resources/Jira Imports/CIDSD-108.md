...
# CIDSD-108: STAGE: Queue View Column arrangement causes unchecked columns to be checked
## Overview
- **Status**: Resolved
- **Created**: 2022-03-01
- **Project**: cidsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/11/CIDSD-108)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
