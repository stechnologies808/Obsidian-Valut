...
# CITSD-299: ALM122: TEST UAT: Panel Spec Sheet required when selecting on list panels
## Overview
- **Status**: Resolved
- **Created**: 2023-04-21
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-299)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
