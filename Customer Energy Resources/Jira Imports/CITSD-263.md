...
# CITSD-263: ALM 85 TEST UAT - PENDING EXECUTION - UNABLE TO PROCEED FROM 'PENDING EXECUTION STATUS' PAGE TO 'EXECUTED' PAGE.
## Overview
- **Status**: Resolved
- **Created**: 2023-04-12
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-263)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
