...
# CITSD-153: Revision received email to customer/contractor does not include attachment.
## Overview
- **Status**: Resolved
- **Created**: 2022-12-16
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-153)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
