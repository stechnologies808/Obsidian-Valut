...
# CITSD-159: Received error message saying "Please complete fields on Contact Information Page". 
## Overview
- **Status**: Closed
- **Created**: 2022-12-20
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-159)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
