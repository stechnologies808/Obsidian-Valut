...
# HESD-120: CIT Workflow: Remove file type restrictions on SDP document uploads in Project Verification
## Overview
- **Status**: Closed
- **Created**: 2022-07-15
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-120)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
