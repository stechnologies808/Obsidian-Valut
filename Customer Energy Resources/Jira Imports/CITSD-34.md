...
# CITSD-34: Unable to remove PV contractor from a pending AMEND application using revision or Change of Contractor function
## Overview
- **Status**: Resolved
- **Created**: 2022-02-13
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-34)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
