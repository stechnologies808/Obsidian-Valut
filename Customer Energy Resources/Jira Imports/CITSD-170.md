...
# CITSD-170: Clarification/confirmation request: The validation document upload fields are not consistent in their accepted file types. Was this requested? If not, is there a particular reason?
## Overview
- **Status**: Closed
- **Created**: 2022-12-29
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-170)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
