...
# HESD-28: Error pop up on Contractor Approval page- Unable to approve any contractors in PROD
## Overview
- **Status**: Closed
- **Created**: 2022-03-22
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-28)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
