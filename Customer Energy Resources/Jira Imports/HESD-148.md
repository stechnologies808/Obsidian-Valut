...
# HESD-148: CIT application wrong status and Start Project Validation link returns me to Landing page
## Overview
- **Status**: Resolved
- **Created**: 2022-09-30
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-148)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
