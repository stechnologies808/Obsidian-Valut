...
# CITSD-67: Cannot move past Start Project Validation chevron when Start Project Verification is already complete.
## Overview
- **Status**: Resolved
- **Created**: 2022-03-04
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-67)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
