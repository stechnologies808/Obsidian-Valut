...
# CITSD-133: Revision Submitted email to customer does not contain Revision Summary Document
## Overview
- **Status**: Closed
- **Created**: 2022-11-22
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-133)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
