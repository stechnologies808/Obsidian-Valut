...
# CITSD-305: ALM 128 TEST UAT - REVISION (AMEND) - After changing the equipment and size for the "Remove" section, the "Total Remove Size" field does not auto-update. Still able to manually update.
## Overview
- **Status**: Closed
- **Created**: 2023-04-25
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-305)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
