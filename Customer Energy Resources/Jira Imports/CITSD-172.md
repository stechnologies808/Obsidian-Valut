...
# CITSD-172: Regression: "Battery Bonus" is missing from Queue View column list
## Overview
- **Status**: Resolved
- **Created**: 2023-01-03
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-172)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
