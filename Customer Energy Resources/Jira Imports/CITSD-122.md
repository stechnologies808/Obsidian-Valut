...
# CITSD-122: No Changes revision causes project summary to display blank Total kW.
## Overview
- **Status**: Resolved
- **Created**: 2022-11-04
- **Project**: citsd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/19/CITSD-122)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
