...
# HESD-118: TEST: Unable to start new Electrical and New Renewable Application
## Overview
- **Status**: Closed
- **Created**: 2022-07-14
- **Project**: hesd
...
## Links
- [View in Jira](https://gridunity.atlassian.net/servicedesk/customer/portal/20/HESD-118)
- Original Summary: 
## Metadata
- **Scraped**: Unknown
